            ...
            override fun onResponse(call: Call<DealObject>?, response: Response<DealObject>?) {
                ...
                if(response?.isSuccessful ?: false) {
                    response?.body()!!.let { response ->
                        ...
                        if(response.deal!=null && response.video!=null)
                        {
...
//            val view = View.inflate(this, R.layout.custom_dialogue_layout, container)
            val editor = getSharedPreferences("notification", MODE_PRIVATE).edit()
            ...
            btnToggleNot.setOnClickListener{
                ...
                if(toggleChecked.equals("True")) {
                    toggleChecked = "False"
                    editor.putString("notifValue", toggleChecked)
                    editor.apply()
                }
                else
                {
                ...
                btnClearData.setOnClickListener {
                    this.deleteDatabase("com.example.taylanwhite.meh.db")
                }
